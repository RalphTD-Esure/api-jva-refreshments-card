...
public class RefreshmentsCardUserServiceTests
{
    ...
    public void registrationSuccess()
    {
        ...
        when(userRepository.findByEmployeeId(ONBOARD_EMPLOYEE_ID)).thenReturn(Optional.empty());
    ...
    public void testRegistrationThrowsUserAlreadyExistsException()
    {
        ...
        when(userRepository.findByEmployeeId(ONBOARD_EMPLOYEE_ID)).thenReturn(Optional.of(userEntity));
